...
def colorize( source, foreground_color='Default', background_color='Default', set_formatting = 'Default', reset_formatting = 'Default' ):
    control = '\033'
...
if __name__ == '__main__':
    def demo( source, foreground_color, background_color, set_formatting, reset_formatting ):
